...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if(p != null) {            
            ViewProductDetailJPanel cnpjp = new ViewProductDetailJPanel(workArea, p);
            workArea.add("ViewProductDetailJPanel", cnpjp);
            CardLayout layout = (CardLayout) workArea.getLayout();
            layout.next(workArea);
        }
        else
            JOptionPane.showMessageDialog(null, "The product do not exist.", "Error", JOptionPane.WARNING_MESSAGE);        
